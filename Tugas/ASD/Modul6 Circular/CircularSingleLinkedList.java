...
public class CircularSingleLinkedList {
    ...
    public static void main(String[] args) {
        ...
        csll.cetak("csll stl sisip 100 di akhir");
        csll.SisipDataDiAkhir(new Integer(200));
        csll.cetak("csll stl sisip 200 di akhir");

        csll.hapusSatuDataDiAwal();
        csll.cetak("csll stl hapus data di awal");

        csll.hapusSatuDataDiAkhir();
        csll.cetak("csll stl hapus data di akhir");
    }
}
